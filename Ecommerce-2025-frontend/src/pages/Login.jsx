        ...
        <form onSubmit={submitHandler}>
          ...
          <CardFooter className="px-10 pb-12 pt-6 flex flex-col gap-6">
            ...
            <div className="text-center">
              <p className="text-xs text-muted-foreground font-bold uppercase tracking-widest mb-1">New to V-Retail?</p>
              <span 
            ...
            <p className="text-xs text-center text-muted-foreground font-medium px-6 leading-relaxed">
              By continuing, you agree to our <span className="text-foreground font-bold cursor-pointer hover:underline">Terms of Service</span> and <span className="text-foreground font-bold cursor-pointer hover:underline">Privacy Policy</span>.
            </p>
          </CardFooter>
        </form>
      </Card>
